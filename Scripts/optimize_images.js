...
const ORIGINAL_IMG_DIR = path.join(IMG_DIR, "original");
...
console.log("Original directory:", ORIGINAL_IMG_DIR);
...
async function runOptimization() {
    ...
    const files = await fs.readdir(ORIGINAL_IMG_DIR, { withFileTypes: true });
    ...
    for (const file of imageFiles) {
        const fullPath = path.join(ORIGINAL_IMG_DIR, file);
